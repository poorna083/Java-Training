...
interface MapsExplored{
    default int mapsExplored(int mapsExplored){
        int b = mapsExplored;
        System.out.println("Exploring "+ b +"adventurous maps..");
        return b;
    }
interface ClubsFound{
    default int clubsfound(int clubsfound){
        int c = clubsfound;
        System.out.println("Collected "+ c +" clubs");
        return c;
    }
}
interface UnlockTreasure{
    default int unlocktreassure(int unlocktreassure){
        if(clubsfound>unlocktreassure){
            System.out.println();
        }
        int d = unlocktreassure;
        System.out.println("Collected "+ d +" clubs");
        return d;
    }
}
